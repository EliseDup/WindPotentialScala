...
object MosaicGrasslandForestShrubland extends LandCoverType("Mosaic Grassland / Forest / Shrubland", LandUseFactor(0.5*0.5), LandUseFactor(0.5*0.5))
object MosaicVegetationCroplands extends LandCoverType("Mosaic Vegetation / Croplands", LandUseFactor((0.5 * 0.5 + 0.5 * 0.8)), LandUseFactor((0.5 * 0.5 + 0.5 * 0.8)))
