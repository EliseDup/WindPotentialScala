...
object Data {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val world = new WorldGrid("../model_data/data_vr_n", Degrees(0.75), List(6, 8, 10, 12))
    ...
    world.writeGrid("world_c_k")

    List(6,8,10,12).map(i => println(i +"\t" + potential(i, true, grids).to(Exajoules) + "\t" + potentialTD(world, i, true, grids).to(Exajoules)) )
